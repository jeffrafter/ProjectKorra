	...
	public void progress() {
		...
		if (ability.equalsIgnoreCase("FireKick")) {
			if (destination == null) {
				...
				player.getWorld().playSound(player.getLocation(), Sound.ENTITY_GENERIC_BURN, 0.5f, 1f);
			...
			if (destination == null) {
				...
				player.getWorld().playSound(player.getLocation(), Sound.ENTITY_GENERIC_BURN, 0.5f, 0.5f);
			...
			if (firstTime) {
				...
				if (progressCounter % 4 == 0) {
					player.getWorld().playSound(player.getLocation(), Sound.ENTITY_GENERIC_BURN, 1, 0F);
				}
			}
		} else if (ability.equalsIgnoreCase("FireWheel")) {
			if (location == null) {
